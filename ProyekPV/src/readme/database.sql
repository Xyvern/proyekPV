...
(23,'Weathering With You','https://www.youtube.com/embed/Q6iK6DjV_iE?si=BXYwYuMW1RAMtRQP','Set during a period of exceptionally rainy weather, high-school boy Hodaka Morishima runs away from his troubled rural home to Tokyo and befriends an orphan girl who can manipulate the weather.','Animation','Blockbusters','...');
