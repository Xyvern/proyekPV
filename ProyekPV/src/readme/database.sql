...
(18,'How To Train Your Dragon','https://www.youtube.com/embed/2AKsAxrhqgM?si=HfYTWvnm1OvRjR7u','Hiccup (Tawin Yavapolkul) is a Norse teenager from the island of Berk, where fighting dragons is a way of life. His progressive views and weird sense of humor make him a misfit, despite the fact that his father (Kongkrapunt Sangsuriya) is chief of the clan. Tossed into dragon-fighting school, he endeavors to prove himself as a true Viking, but when he befriends an injured dragon he names Toothless, he has the chance to plot a new course for his people\'s future.','Animation','For kids','/src/assets/banner/httyd.jpeg'),
