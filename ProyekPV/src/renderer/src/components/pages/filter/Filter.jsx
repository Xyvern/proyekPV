  ...
  return (
    <Box>
      ...
      <Box className="flex flex-row gap-4">
        ...
        <Box className='mr-4'>
          {/* Button Filter */}
          <button className='text-white text-sm  bg-[#ffffff2c] pr-2 pl-4 py-2 border-solid rounded-lg font-semibold shadow-lg  btn hover:bg-[#ffffff49]' onClick={()=>hasilfilter(genre,category,sort)}>Filter<span className="ml-2" ></span></button>
        </Box>
      </Box>
